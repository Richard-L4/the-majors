...
![Images of front page of project on all device sizes](/assets/images/all-devices.png)
...
- During the project my ideas changed several times as to how to structure it and the content and styling to use, in HTML, CSS and readme.md. Below are challenges I faced and the reasons as to the decisions that were made.
    ...
    - My final issue was under advice from my mentor to alter the navigation tabs so that while they do still move when hovered on, they don't cause the one's to either side to move. The solution was to "scale" rather than "hover".
